...
array<const CD3DX12_STATIC_SAMPLER_DESC, 7> ShadowMapApp::GetStaticSamplers()
{
...
void ShadowMapApp::OnKeyboardInput()
{
...
void ShadowMapApp::UpdateMaterialBuffer()
{
...
void ShadowMapApp::UpdateMainPassCB()
{
	...
	passConstants.lights[0].strength = { 0.9f, 0.8f, 0.8f };
...
void ShadowMapApp::UpdateShadowTransform()
{
	// 主光才投射物体阴影
...
void ShadowMapApp::BuildDescriptorHeaps()
{
	...
	auto nullSrv = CD3DX12_CPU_DESCRIPTOR_HANDLE(srvCpuStart, mNullCubeSrvIndex, csuDescriptorSize);
	mNullSrv = CD3DX12_GPU_DESCRIPTOR_HANDLE(srvGpuStart, mNullCubeSrvIndex, csuDescriptorSize);
	...
	mShadowMap->BuildDescriptors(
		CD3DX12_CPU_DESCRIPTOR_HANDLE(srvCpuStart, mShadowMapHeapIndex, csuDescriptorSize),
		CD3DX12_GPU_DESCRIPTOR_HANDLE(srvGpuStart, mShadowMapHeapIndex, csuDescriptorSize),
...
void ShadowMapApp::BuildFrameResource()
{
...
void ShadowMapApp::DrawRenderItems(vector<RenderItem*>& ritems)
{
